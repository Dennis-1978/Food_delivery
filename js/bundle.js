...
function forms(formSelector, modalTimerId) {
    ...
    // Связываем формы с функцией bindPostData
    forms.forEach(item => {
        bindPostData(item);
    });
...
// Отправляет GET-запрос. Формирует исключение для catch
...
window.addEventListener("DOMContentLoaded", () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__.default)(".timer", "2021-07-29");
